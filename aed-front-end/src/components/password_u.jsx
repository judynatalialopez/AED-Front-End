...
import '../styles/password_u.css';
import { FaUser, FaLock } from 'react-icons/fa';
import { HiIdentification } from 'react-icons/hi';

const Update_Password_u = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://192.168.101.6:3000/api/usuario/updatePassword', {
                method: 'PUT',
                headers: {
...
export default Update_Password_u;
